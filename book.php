        ...
        <div class="row">
            ...
            <div class="col-xs-12 text-center menu-1 menu-wrap">
                <ul>
                    ...
                    <li class="active"><a href="reservation.html">Booking</a></li>
...
<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(images/hero_1.jpeg);" data-stellar-background-ratio="0.5">
    ...
    <div style="flex: 1; padding-left: 5cap;">
        <h1 style="color: cadetblue;">Fill and submit the form to book our residency:</h1>
    </div>
				<div class="col-md-6 col-md-push-6 col-sm-6 col-sm-push-6" style="padding-top: 3cap;">
